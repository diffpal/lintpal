...
Install [Task](tasks.md), then make both revisions available locally.
...
To use more rules, [import them](../rules/import.md) into `.lintpal/rules/`, review
...
failure; see [CLI exit codes](../reference/cli.md). Inspect the report only when the current
...
[privacy and limitations](../architecture/privacy.md) before choosing an endpoint or sharing
the report.
