...
func TestNewAnchorsAndSort(t *testing.T) {
	...
	decision := rules.Decision{RuleID: "r", WorkItemID: item.ID, Path: item.Path, Side: item.Side, StartLine: 2, EndLine: 3, Severity: rules.High, Title: "Title", Message: "Message", Kind: "noul_probability", Value: .8}
