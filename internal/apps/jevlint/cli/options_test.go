...
func TestResolvePrecedenceAndTrust(t *testing.T) {
	env := map[string]string{"JEVLINT_BASE": "env-base", "JEVLINT_HEAD": "env-head", "JEVLINT_PROVIDER": "openrouter", "JEVLINT_FAIL_ON": "none", "JEVLINT_TIMEOUT": "3m"}
	...
	if err != nil || o.AuthTokenEnv != "JEVLINT_TOKEN" {
